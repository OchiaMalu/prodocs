...
<img src="http://niu.ochiamalu.site/image-20240927125204195.png" alt="image-20240927125204195" style="zoom:80%;margin:0 auto" />

## 使用 Locale 类定义语言环境

如果要对用户使用的语言环境进行定义，则可以使用 `java.util.Locale` 类完成，此类定义的常用方法如表所示。

<img src="http://niu.ochiamalu.site/image-20240927125240098.png" alt="image-20240927125240098" style="zoom:80%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.site/image-20240927125553035.png" alt="image-20240927125553035" style="zoom:80%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.site/image-20240927125932389.png" alt="image-20240927125932389" style="zoom:80%;margin:0 auto" />
