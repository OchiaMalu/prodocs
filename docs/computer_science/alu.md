...
<img src="http://niu.ochiamalu.fun/image-20231005194945570.png" alt="image-20231005194945570" style="zoom: 80%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231005204640192.png" alt="image-20231005204640192" style="zoom:50%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231005195835962.png" alt="image-20231005195835962" style="zoom:80%;margin:0 auto" />

很好，这样就能表示 1+1=10 了，一个异或门+与门这样的结构我们称之为 **半加器** （half adder），是实现两个一位二进制数的加法运算电路。

<img src="http://niu.ochiamalu.fun/image-20231005200045053.png" alt="image-20231005200045053" style="zoom: 80%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231005200449567.png" alt="image-20231005200449567" style="zoom:50%;margin:0 auto" />

这时候我们需要一个或门来判断是剩下的余数是 1 还是 0 。

<img src="http://niu.ochiamalu.fun/image-20231005200645543.png" alt="image-20231005200645543" style="zoom:50%;margin:0 auto" />

像这样的结构，我们称之为 **全加器** （full adder）。

<img src="http://niu.ochiamalu.fun/image-20231005200815694.png" alt="image-20231005200815694" style="zoom:50%;margin:0 auto" />

### 八位行波进位加法器

当我们将两个 8 位二进制数相加时，前两位只需要用 **半加器** 就可以做到，后面的我们需要使用 **全加器** 。

<img src="http://niu.ochiamalu.fun/image-20231005201401260.png" alt="image-20231005201401260" style="zoom:50%;margin:0 auto" />

横向的图不是很好看，我们将它翻转 90° 。

<img src="http://niu.ochiamalu.fun/%E5%B1%8F%E5%B9%95%E6%88%AA%E5%9B%BE%202023-10-05%20201521.jpg" alt="屏幕截图 2023-10-05 201521" style="zoom:50%;margin:0 auto" />

你想到了什么？

这不就是小学老师教的 **竖式** 吗？

<img src="http://niu.ochiamalu.fun/image-20231005202006019.png" alt="image-20231005202006019" style="zoom:50%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231005204351446.png" alt="image-20231005204351446" style="zoom:80%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231005203542545.png" alt="image-20231005203542545" style="zoom:50%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231005205330702.png" alt="image-20231005205330702" style="zoom:50%;margin:0 auto" />
