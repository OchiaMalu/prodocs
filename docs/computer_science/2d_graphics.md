...
<img src="http://niu.ochiamalu.fun/image-20231023130128097.png" alt="image-20231023130128097" style="zoom:80%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231023130336709.png" alt="image-20231023130336709" style="zoom:80%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231023130422045.png" alt="image-20231023130422045" style="zoom:80%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231023130454293.png" alt="image-20231023130454293" style="zoom:80%;margin:0 auto" />

2. 按固定路径，一行行来，从上向下，从左到右，不断重复，只在特定的点打开电子束，以此绘制图形，这叫 `光栅扫描` （Raster
   Scanning），用这种方法，可以用很多小线段绘制形状，甚至文字。

<img src="http://niu.ochiamalu.fun/image-20231023130529516.png" alt="image-20231023130529516" style="zoom:80%;margin:0 auto" />

## 液晶显示屏

最后，因为显示技术的发展，我们终于可以在屏幕上显示清晰的点，叫 `像素` （pixels）。

<img src="http://niu.ochiamalu.fun/image-20231023130556460.png" alt="image-20231023130556460" style="zoom:80%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231023130640262.png" alt="image-20231023130640262" style="zoom:80%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231023130843175.png" alt="image-20231023130843175" style="zoom:80%;margin:0 auto" />

某些系统上，可以用额外的 bit 定义字体颜色和背景颜色做出这样的 DOS 界面，这界面只用了刚刚提到的字符集。

<img src="http://niu.ochiamalu.fun/image-20231023130917070.png" alt="image-20231023130917070" style="zoom:80%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231023131159001.png" alt="image-20231023131159001" style="zoom:80%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231023131256365.png" alt="image-20231023131256365" style="zoom:80%;margin:0 auto" />

笔尖用光线传感器，可以检测到显示器刷新，通过判断刷新时间，电脑可以知道笔的位置，有了光笔和各种按钮，用户可以画线和其他简单形状。

<img src="http://niu.ochiamalu.fun/image-20231023131318798.png" alt="image-20231023131318798" style="zoom:80%;margin:0 auto" />

`Sketchpad` 可以让线条完美平行，长度相同，完美垂直90度，甚至动态缩放，这些在纸上很费力，在计算机上非常简单！

用户还可以保存设计结果，方便以后再次使用，甚至和其他人分享。

<img src="http://niu.ochiamalu.fun/image-20231023131454140.png" alt="image-20231023131454140" style="zoom:80%;margin:0 auto" />
...
<img src="http://niu.ochiamalu.fun/image-20231023131556220.png" alt="image-20231023131556220" style="zoom:80%;margin:0 auto" />
