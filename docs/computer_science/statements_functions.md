...
<img src="http://niu.ochiamalu.site/image-20231011140139099.png" alt="image-20231011140139099" style="zoom:80%;margin: 0 auto" />

当然各个语言都是大同小异，有些有圆括号，有些有花括号，但基本都是 `if + 表达式 + 要做的事` 。

除了 if 还有 else，如果当 表达式 为 False，那么就会执行 else 中的语句。

<img src="http://niu.ochiamalu.site/image-20231011140413665.png" alt="image-20231011140413665" style="zoom:80%;margin: 0 auto" />
...
<img src="http://niu.ochiamalu.site/image-20231011141337880.png" alt="image-20231011141337880" style="zoom:80%;margin: 0 auto" />
...
<img src="http://niu.ochiamalu.site/image-20231011141441431.png" alt="image-20231011141441431" style="zoom:80%;margin: 0 auto" />
